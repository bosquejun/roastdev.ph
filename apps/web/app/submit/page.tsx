...
export default function SubmitPage() {
  ...
  return (
    <div className="mx-auto max-w-xl p-8">
      <div className="mb-8">
        <div className="overflow-hidden rounded-t-lg border-2 border-border bg-card">
          <div className="flex items-center gap-2 border-b border-border bg-card px-4 py-2">
            ...
            <span className="ml-3 text-xs font-bold tracking-wider text-muted-foreground uppercase">
              submit_startup.exe
            </span>
          </div>
